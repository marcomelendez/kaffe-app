...
class SetupStore
{
    ...
    public function __construct()
    {
     ...
     /**
       ...
       * @return string
       */
      public static function createDayTable($table_name, $type, $action = 'CREATE') {
        // Schema::db
        ...
        $command = $action. ' TABLE ' . 'bat_event_'.$table_name.'_day_'.$type;
       ...
       * @return string
       */
      public static function createHourTable($table_name, $type, $action = 'CREATE') {
        $command = $action . ' TABLE ' . 'bat_event_'.$table_name.'_hour_'.$type;
        if ($action === 'CREATE') {
       ...
       * @return string
       */
      public static function createMinuteTable($table_name, $type, $action = 'CREATE') {
        $command = $action . ' TABLE ' . 'bat_event_'.$table_name.'_minute_'.$type;
        if($action === 'CREATE'){
